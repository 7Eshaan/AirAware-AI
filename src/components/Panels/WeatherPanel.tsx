...
export const WeatherPanel: React.FC<WeatherPanelProps> = ({ data }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-[340px] shrink-0 p-3.5 rounded-2xl bg-slate-950/75 border border-white/10 backdrop-blur-xl shadow-2xl text-white pointer-events-auto"
    >
      {/* Header */}
