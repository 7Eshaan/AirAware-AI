...
export const AQIPanel: React.FC<AQIPanelProps> = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 border-b border-white/10 pb-3 mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-[10px] text-slate-400">Open-Meteo Air Quality API</div>
          </div>
        </div>

        {/* Standard Switcher (US EPA vs European EAQI) */}
        <div className="flex items-center p-0.5 rounded-lg bg-white/10 border border-white/10 text-[10px] font-semibold">
          <button
      ...
      {/* Progress Track */}
      <div className="w-full h-2 rounded-full overflow-hidden bg-slate-800 flex mb-3">
      ...
      <div className="grid grid-cols-2 gap-2 pt-1 text-xs mb-2">
        <div className="p-2 rounded-xl bg-white/5 border border-white/5">
          <div className="flex justify-between text-[11px] text-slate-400">
            <span className="font-bold text-white">PM2.5</span>
            <span className="text-[10px]">{data.pollutants.pm25.status}</span>
          </div>
          <div className="text-base font-bold text-white mt-0.5">
            {data.pollutants.pm25.value} <span className="text-[10px] font-normal text-slate-400">µg/m³</span>
          </div>
        </div>
        ...
        <div className="p-2 rounded-xl bg-white/5 border border-white/5">
          <div className="flex justify-between text-[11px] text-slate-400">
            ...
            <span className="text-[10px]">{data.pollutants.pm10.status}</span>
          </div>
          <div className="text-base font-bold text-white mt-0.5">
            {data.pollutants.pm10.value} <span className="text-[10px] font-normal text-slate-400">µg/m³</span>
          </div>
        </div>
        ...
        <div className="p-2 rounded-xl bg-white/5 border border-white/5">
          <div className="flex justify-between text-[11px] text-slate-400">
            ...
            <span className="text-[10px]">{data.pollutants.no2.status}</span>
          </div>
          <div className="text-base font-bold text-white mt-0.5">
            {data.pollutants.no2.value} <span className="text-[10px] font-normal text-slate-400">µg/m³</span>
          </div>
        </div>
        ...
        <div className="p-2 rounded-xl bg-white/5 border border-white/5">
          <div className="flex justify-between text-[11px] text-slate-400">
            ...
            <span className="text-[10px]">{data.pollutants.o3.status}</span>
          </div>
          <div className="text-base font-bold text-white mt-0.5">
            {data.pollutants.o3.value} <span className="text-[10px] font-normal text-slate-400">µg/m³</span>
          </div>
        </div>
      </div>
